	...
	<div class="container">
		...
		<form:form action="${pageContext.request.contextPath }/admin/productInventory/addProduct" method="post" commandName="product">
			...
			<div class="form-group">
				...
				<form:radiobutton path="productCategory" value="instrument" label="Instrument" /> 
				<form:radiobutton path="productCategory" value="record" label="Record" /> 
            	<form:radiobutton path="productCategory" value="accessory" label="Accessory" />
			</div>
			...
			<div class="form-group">
				...
				<form:radiobutton path="productStatus" value="inactive" label="Inactive" /> 
			</div>
